...
local memory_aliases = {
  ...
  nesPpuMemory = emu.memType.nesPpuMemory,
  ...
  nesNametableRam = emu.memType.nesNametableRam,
  nesPaletteRam = emu.memType.nesPaletteRam,
  nesSpriteRam = emu.memType.nesSpriteRam,
  nesSecondarySpriteRam = emu.memType.nesSecondarySpriteRam,
  ...
  pceAdpcmRam = emu.memType.pceAdpcmRam,
  pceArcadeCardRam = emu.memType.pceArcadeCardRam,
  pceVideoRam = emu.memType.pceVideoRam,
  pceSpriteRam = emu.memType.pceSpriteRam,
  pcePaletteRam = emu.memType.pcePaletteRam,
